...
<head>
    ...
    <title>@yield('title', 'Owner') — Spare Parts</title>
    ...
    <div class="d-flex">
        <nav class="sidebar d-flex flex-column p-3" style="width:240px; min-width:240px;">
            <a href="{{ route('owner.dashboard') }}"
                ...
                <i class="bi bi-bar-chart-fill fs-4 me-2 text-warning"></i>
                <span class="fw-bold">Owner Panel</span>
            </a>
            <hr class="border-secondary">

            <ul class="nav flex-column mb-2">
                <li><a href="{{ route('owner.dashboard') }}" class="nav-link @active('owner/dashboard*')">
